    ...
    return (
        <div className="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
            <div className="flex flex-column align-items-center justify-content-center">
                <div style={{ borderRadius: '30px', padding: '2rem', background: 'linear-gradient(180deg, rgba(77, 11, 108, 0.4) 10%, rgba(33, 150, 243, 0))' }}>
                    ...
                    <img src={`${contextPath}/layout/images/Kraken-logo-dark.png`} alt="kraken logo" className="mb-5 w-6rem flex-shrink-0"/>
                        <span className="font-bold text-3xl" style={{ color: "#702158"}}>404</span>
