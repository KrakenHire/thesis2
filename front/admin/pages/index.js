...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        serviceservice.getServicesDash().then((data) => setServices(data));
    }, []);
        ...
        <div className="grid">
            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    ...
                    <DataTable value={services} rows={5} paginator responsiveLayout="scroll">
                        <Column field="Service" header="Service" sortable style={{ width: '35%' }} />
                        <Column field="Name" header="Provider" sortable style={{ width: '35%' }} />
